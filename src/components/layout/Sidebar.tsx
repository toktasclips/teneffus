...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col fixed top-0 left-0 h-full w-60 bg-[var(--bg-secondary)] border-r border-[var(--border-primary)]">
      {/* Logo */}
      <div className="px-6 h-16 flex items-center border-b border-[var(--border-primary)] shrink-0">
        <span className="text-[var(--text-primary)] font-semibold text-base tracking-tight select-none">
          Teneffüs
        </span>
      </div>
      ...
      {/* Footer */}
      <div className="px-5 py-4 border-t border-[var(--border-primary)] shrink-0">
